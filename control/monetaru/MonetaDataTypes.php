 ...
 * Тип, описывающий параметры операции в запросах.
	 ...
	 * 
 */	
class MonetaTransactionRequestType extends MonetaEntity
{
 ...
 * Тип, описывающий параметры операции в запросах в пакетном режиме.
	 ...
	 * 
 */	
class MonetaTransactionBatchRequestType extends MonetaEntity
{
	 ...
	 * @return void
	 */
	public function addTransaction(MonetaEntity $item)
	{
...
class MonetaTransactionBatchResponseType
{
	 ...
	 * For retrieving errorCode the request attribute "version" has to be set to "VERSION_2" or grater.
 ...
 * Тип, описывающий параметры операции в запросах. Отличается от TransactionRequestType тем, что в качестве получателя можно указывать не только номер счета.
	 ...
	 * 
 */	
class MonetaPaymentRequestType extends MonetaEntity
{
 ...
 * Тип, описывающий параметры операции в запросах в пакетном режиме.
	 ...
	 * 
 */	
class MonetaAuthoriseTransactionBatchRequestType extends MonetaEntity
{
 ...
 * Тип для запроса подтверждения операции в пакетном режиме.
	 ...
	 * 
 */	
class MonetaConfirmTransactionBatchRequestType extends MonetaEntity
{
 ...
 * Тип для запроса на отмену операций в пакетном режиме.
	 ...
	 * 
 */	
class MonetaCancelTransactionBatchRequestType extends MonetaEntity
{
 ...
 * Тип, описывающий параметры операции в запросах в пакетном режиме.
	 ...
	 * 
 */	
class MonetaInvoiceBatchRequestType extends MonetaEntity
{
	 ...
	 * 
	 * 
	 * @param MonetaInvoiceRequestType
	 *
	 * @return void
	 */
	public function addTransaction(MonetaInvoiceRequestType $item)
	{
		$this->transaction[] = $item;
	}
 ...
 * Выставление счета к оплате.
	 ...
	 * 
 */	
class MonetaInvoiceRequest extends MonetaInvoiceRequestType
{
 ...
 * Запрос на перевод денежных средств. Отличается от TransferRequest тем, что в качестве получателя можно указывать не только номер счета.
	 ...
	 * 
 */	
class MonetaPaymentRequest extends MonetaPaymentRequestType
{
 ...
 * Запрос возможности провести операцию в системе МОНЕТА.РУ.
	 ...
	 * 
 */	
class MonetaVerifyTransactionRequest extends MonetaEntity
{
 ...
 * Ответ на запрос проверки проведения операции в системе МОНЕТА.РУ
	 ...
	 * 
 */	
class MonetaVerifyTransactionResponse extends MonetaVerifyTransactionResponseType
{
 ...
 * Запрос возможности провести операцию в системе МОНЕТА.РУ. Отличается от VerifyTransferRequest тем, что в качестве получателя можно указывать не только номер счета.
	 ...
	 * 
 */	
class MonetaVerifyPaymentRequest extends MonetaPaymentRequestType
{
