<div class="row-fluid sections">
    ...
    <div class="span2 item"  data-step='2' data-intro='Раздел &laquo;Диспетчер&raquo; позволяет оперативно отслеживать состояние всего автопарка или выбранной группы машин, в удобном виде.'>
    ...
    <div class="span2 item" data-step='3' data-intro='Раздел &laquo;Статистика&raquo; является центром получения всех необходимых статистических данных по каждой машине в виде таблиц и графиков, с возможностью экспорта данных в MS Excel, CSV, XML или JSON-формат.'>
    ...
    <div class="span2 item" data-step='5' data-intro='В разделе &laquo;Автопарк&raquo; вы можете добавлять новые машины в свой парк, включать или отключать наблюдение за машинами, настраивать их параметры, присваивать им водителей и многое другое.'>
    ...
    <div class="span2 item" data-step='6' data-intro='В разделе &laquo;Группы&raquo; можно объединять машины в отдельные группы, с целью отделения, скажем грузовых авто от пассажирских, наземных ТС от водных...'>
