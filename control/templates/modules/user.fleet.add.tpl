        ...
        <div class="row">
            ...
            <div class="half">
                <div class="forms">
                    ...
                    <p>Это нужно, чтобы вам было легче находить ваши автомобили на карте.
                    ...
                    <p>
                        <em>
                            Вводите госномер посимвольно, он автоматически будет сконвертирован
        ...
        <div class="row">
            ...
            <div class="half">
                <div class="forms forms-white">
                    ...
                    <hr>
                    Внимание! Не выбрасывайте карточку, после завершения активации, она вам может пригодится,
                    если вы будете обращаться в <a href="/control/about/feedback/">техподдержку Картрека</a>.
                </div>
            </div>
        </div>
