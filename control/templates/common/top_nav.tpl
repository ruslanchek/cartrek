        ...
        <div class="container-fluid">
            ...
            <div class="nav-collapse">
                ...
                <ul class="nav pull-right">
                    {if $core->auth->user.status}
                        <li{if $core->module.name == 'events'} class="active"{/if}><a href="/control/events">{if $core->auth->user.data.new_events_count > 0}<span class="badge badge-warning">{$core->auth->user.data.new_events_count}</span>{/if} Уведомления</a></li>
                        <li class="divider-vertical"></li>
