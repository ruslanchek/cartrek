...
<link rel="stylesheet" href="/control/resources/plugins/jquery-ui/ui-lightness/jquery-ui-1.8.20.custom.css" type="text/css" />
...
<script src="/control/resources/plugins/jquery-ui/jquery-ui-1.8.20.custom.min.js"></script>
